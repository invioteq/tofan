...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceReadinessCriteria) DeepCopyInto(out *ResourceReadinessCriteria) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceReadinessCriteria.
func (in *ResourceReadinessCriteria) DeepCopy() *ResourceReadinessCriteria {
	if in == nil {
		return nil
	}
	out := new(ResourceReadinessCriteria)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TestCaseSpec) DeepCopyInto(out *TestCaseSpec) {
	*out = *in
	...
	if in.ReadinessCriteria != nil {
		...
		*out = make([]ResourceReadinessCriteria, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
