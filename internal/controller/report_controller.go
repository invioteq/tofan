...
//+kubebuilder:rbac:groups=tofan.io.tofan.io,resources=reports,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=tofan.io.tofan.io,resources=reports/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=tofan.io.tofan.io,resources=reports/finalizers,verbs=update
