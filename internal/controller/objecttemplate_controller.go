...
//+kubebuilder:rbac:groups=tofan.io.tofan.io,resources=objecttemplates,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=tofan.io.tofan.io,resources=objecttemplates/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=tofan.io.tofan.io,resources=objecttemplates/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the ObjectTemplate object against the actual cluster state, and then
